 ...
 */
    public Line(double m,FloatPoint p){
this.m=m;
this.c=p.y-(m*p.x);
    }
 ...
 */
    public Line(double x1,double y1, double x2,double y2){
        this.m = new FloatPoint(x1,y1).findXYGrad(new FloatPoint(x2,y2));
        this.c=y1-this.m*x1;
    }
 ...
 * Creates a line between points joining: the points p1 and p2
  ...
  */
    public Line(FloatPoint p1,FloatPoint p2){
 ...
 * object between the 2 given Point objects lying on it
 */
public double distance(FloatPoint p1,FloatPoint p2){
    double dist=0;
    if(passesThroughPoint(p1)&&passesThroughPoint(p2)){
 ...
 * object between the 2 given Point objects lying on it
 */
public double distanceSquared(FloatPoint p1,FloatPoint p2){
    double dist=0;
    if(passesThroughPoint(p1)&&passesThroughPoint(p2)){
 ...
 * @return true if it lies on this Line object
 */
    public boolean passesThroughPoint(FloatPoint p1){
    return approxEquals( p1.y, (this.m*p1.x+this.c) );
    }
 ...
 */
public FloatPoint intersectionWithLine(Line line){
 ...
 * where drawing is to start
 */
public void draw(Graphics g,int x1, int x2){
     g.setColor(Color.BLACK); 
    g.drawLine(x1, (int) getY(x1),x2, (int) getY(x2));
